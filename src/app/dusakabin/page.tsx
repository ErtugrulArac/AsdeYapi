...
import Textaw from "@/components/textawdusakabin";
import Products from "@/components/dusakabinproducts"; // yeni ürün componenti
  ...
  return (
    <main className="w-full font-sans bg-white ">
      ...
      <section className="relative h-[90vh] w-full">
        <Image
          src="/dusakabin/dusakabin-hero.webp"
          alt="Duşakabin Bursa"
          fill
        ...
        <div className="absolute inset-0 flex flex-col gap-6 items-center justify-center text-center px-6">
          <h1 className={`${urbanist.className} text-4xl md:text-6xl md:w-[40%] font-black uppercase text-white drop-shadow-lg`}>
            MODERN VE ŞIK DUŞAKABİN ÇÖZÜMLERİ
          </h1>
          <p className={`text-sm w-[80%] max-md:text-center max-md:w-full sm:text-base md:text-lg lg:text-xl text-gray-300`}>
            Asde Yapı, banyonuz için dayanıklı, estetik ve fonksiyonel duşakabin sistemleri sunar.
          </p>
      ...
      <section>
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-xs text-gray-600 mb-2">Duşakabin projelerimizi keşfedin. (Resimlere tıklayarak inceleyebilirsiniz.)</p>
            ...
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <div className="rounded-xl h-[340px] max-md:h-80 overflow-hidden transform hover:scale-105 transition-transform duration-300">
                  <img src="/dusakabin/dus1.webp" alt="[Modern duşakabin]" className="w-full h-auto object-cover" />
                </div>
                <div className="rounded-xl h-[340px] max-md:h-80 overflow-hidden transform hover:scale-105 transition-transform duration-300">
                  <img src="/dusakabin/dus2.webp" alt="[Köşe duşakabin]" className="w-full h-auto object-cover" />
                </div>
                <div className="rounded-xl h-[340px] max-md:h-80 overflow-hidden transform hover:scale-105 transition-transform duration-300">
                  <img src="/dusakabin/dus3.webp" alt="[Temperli cam duşakabin]" className="w-full h-auto object-cover" />
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                name: "Merve Demir",
                comment: "Duşakabinimiz tam istediğimiz gibi oldu, çok memnun kaldık.",
              },
              {
                name: "Hasan Yılmaz",
                comment: "Kaliteli işçilik ve zamanında teslimat. Tavsiye ederim.",
              },
              {
                name: "Ayşe Koç",
                comment: "Banyom artık çok daha şık görünüyor, teşekkürler.",
              },
            ].map((item, i) => (
