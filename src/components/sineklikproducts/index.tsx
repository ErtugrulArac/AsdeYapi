...
export default function KategoriBileseni() {
    ...
    const kategoriler: Kategori[] = [
        ...
        { id: "sineklik", title: "Sineklik", imageSrc: "/images/cam-balkon.png" },
    ...
    return (
        <section className="py-16 sm:py-20 px-4 bg-[#2C2F33] font-inter relative">
            <div className="text-center mb-10 sm:mb-12">
                <h2 className={`text-2xl sm:text-3xl md:text-4xl  text-white tracking-wide font-black ${inter.className}`}>SİNEKLİK MODELLERİMİZ</h2>
