    ...
    <main className="  pt-12 pb-12 gap-12 flex flex-col items-center  text-left">
      ...
      <div className="grid grid-cols-1 gap-10  md:grid-cols-3 max-w-6xl  max-md:w-[85%] max-md:m-auto">
        <div className="flex flex-col">
          ...
          <p className={`${manrope.className} text-2xl max-md:text-xl font-black mb-2 text-[#2E2B16]`}>1000+ Tamamlanmış Montajla Sahadayız</p>
        ...
        <div className="flex flex-col ">
          ...
          <p className={`${manrope.className} text-2xl max-md:text-xl font-black mb-2 text-[#2E2B16]`}>Dayanıklı ve Kaliteli Malzemeler</p>
          <p className={`${manrope.className} text-[#585849] max-md:text-sm text-md max-w-xs`}>
        ...
        <div className="flex flex-col">
          ...
          <p className={`${manrope.className} text-2xl max-md:text-xl font-black mb-2 text-[#2E2B16]`}>Uygun Fiyat, Şeffaf Teklif</p>
          <p className={`${manrope.className} text-[#585849] max-md:text-sm text-md max-w-xs`}>
