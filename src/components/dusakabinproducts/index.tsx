...
export default function KategoriBileseni() {
  const [aktifKategoriId, setAktifKategoriId] = useState("dusakabin");

  const kategoriler: Kategori[] = [
    { id: "dusakabin", title: "Duşakabin", imageSrc: "/images/dusakabin.png" },
  ];
  ...
  const urunler: Urun[] = [
    {
      ...
      imageSrc: "dusakabin/dus-temperli.webp",
      kategoriId: "dusakabin",
    },
    {
      id: "2",
      title: "Köşe Duşakabin",
      imageSrc: "dusakabin/dus-kose.webp",
      kategoriId: "dusakabin",
    },
    {
      id: "3",
      title: "Oval Duşakabin",
      imageSrc: "dusakabin/dus-oval.webp",
      kategoriId: "dusakabin",
    },
  ];
